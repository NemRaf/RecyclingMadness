...
public class Road extends World
{
    ...
    public void act(){
        ...
        for(Glass obj: getObjects(Glass.class))
        {
    ...
    private void createGlass(){
        ...
        if (random1 ==0)
        {
            GreenfootImage image = bottle.getImage();
            addObject(bottle,getWidth(),random);
        }else if(random1==1)
        {
            GreenfootImage image = vase.getImage();
            addObject(vase,getWidth(),random);
        }else
        {
            GreenfootImage image = wine.getImage();
            addObject(wine,getWidth(),random);
        }
